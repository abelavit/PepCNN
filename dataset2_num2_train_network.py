...
file = open("dataset2_Train_Positives_rerun.dat",'rb')
positive_set = pickle.load(file)
file = open("dataset2_Train_Negatives_All_rerun.dat",'rb')
...
# load test data
file = open("dataset2_Test_Samples_rerun.dat",'rb')
...
checkpoint = tf.keras.callbacks.ModelCheckpoint("dataset2_best_model_weights_rerun.h5", save_best_only=True)
